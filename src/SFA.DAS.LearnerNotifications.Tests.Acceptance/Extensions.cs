...
namespace SFA.DAS.LearnerNotifications.Tests.Acceptance
{
    public static class Extensions
    {
        public static bool IsMessage(this Type type)
        {
            ...
            if (@namespace != null && @namespace.StartsWith("SFA.DAS.Payments"))
            {
                return type.Namespace?.Contains(".Messages") ?? false;
            }
