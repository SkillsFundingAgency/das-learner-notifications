-- Insert status values only if they do not already exist
...
-- Insert urgency values only if they do not already exist
...
-- Insert sample notifications only if they do not already exist
...
FROM (VALUES
    ...
    (1001, 'A3B2C1D4-E5F6-7890-ABCD-EF1234567890', 'SystemAlert',
    ...
    (1002, 'A3B2C1D4-E5F6-7890-ABCD-EF1234567890', 'TrainingReminder',
    ...
    (1003, 'B4C3D2E1-F6E5-8901-BCDE-FA2345678901', 'ApprenticeshipUpdate',
    ...
    (1004, 'B4C3D2E1-F6E5-8901-BCDE-FA2345678901', 'Assessment',
    ...
    (1005, 'C5D4E3F2-1728-9012-CDEF-AB3456789012', 'Feedback',
    ...
    (1006, 'C5D4E3F2-1728-9012-CDEF-AB3456789012', 'Account',
     'Verify Your Account',
    ...
    (1007, 'D6E5F4A3-2839-0123-DE4A-BC4567890123', 'SystemAlert',
...
WHERE NOT EXISTS (
    ...
    WHERE n.[NotificationId] = v.[NotificationId]
);
GO
...
-- Insert status history for the notifications only if they do not already exist
...
WHERE NOT EXISTS (
    ...
    WHERE sh.[StatusHistoryId] = v.[StatusHistoryId]
);
GO
